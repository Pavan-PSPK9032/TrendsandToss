...
export default function Register() {
  ...
  return (
    <div className="max-w-md mx-auto p-4 mt-20">
      <h1 className="font-playfair text-3xl font-semibold mb-2 text-center text-navy">Create Account</h1>
      <p className="text-center text-navy/50 text-sm tracking-wide mb-8">Join the Trends&amp;Toss community</p>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="px-3 bg-white text-navy/40 uppercase tracking-widest">Or register with email</span>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="bg-white border border-navy/10 p-6 space-y-5">
        <div>
          <label className="block text-navy/70 mb-2 text-xs font-semibold uppercase tracking-wider">Full Name</label>
          <input 
            type="text" 
            value={name}
        ...
        <div>
          <label className="block text-navy/70 mb-2 text-xs font-semibold uppercase tracking-wider">Phone Number</label>
          <input 
            type="tel" 
            value={phone}
        ...
        <p className="text-center text-navy/50 text-sm">
          ...
          <Link to="/login" className="text-gold font-semibold hover:text-gold-dark">Login</Link>
        </p>
      </form>
    </div>
  )
